...
export default function ContactForm() {
  ...
  if (status === 'success') {
    return (
      <div className="bg-[#0d0d0d] p-8 sm:p-12 md:p-14 rounded-3xl sm:rounded-[36px] border border-emerald-500/40 shadow-2xl space-y-6 animate-fadeIn">
        ...
        <div className="p-4 rounded-2xl bg-black/60 border border-white/10 font-poppins text-xs text-neutral-400 space-y-1">
          <p>Recipient: Bright Face Barber Team</p>
          <p>Expected Response: Within 2–4 hours during opening hours</p>
        </div>
  ...
  // Form view
  return (
    <div className="bg-[#0d0d0d] p-7 sm:p-10 md:p-12 rounded-3xl sm:rounded-[36px] border border-white/10 shadow-2xl">
      
      <div className="space-y-2 mb-8 pb-6 border-b border-white/10">
        <span className="font-poppins text-[10px] uppercase tracking-[0.2em] text-emerald-400 block font-semibold">
          Contact Us
        </span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div className="space-y-2">
            ...
            <input 
              ...
              className={`w-full bg-black/60 border p-4 text-white text-sm focus:outline-none transition-colors rounded-2xl font-sans placeholder:text-neutral-600 ${
                touched.name && errors.name ? 'border-red-500' : 'border-white/15 focus:border-emerald-500'
              }`} 
          ...
          <div className="space-y-2">
            ...
            <input 
              ...
              required
              className={`w-full bg-black/60 border p-4 text-white text-sm focus:outline-none transition-colors rounded-2xl font-sans placeholder:text-neutral-600 ${
                touched.email && errors.email ? 'border-red-500' : 'border-white/15 focus:border-emerald-500'
              }`} 
        ...
        <div className="space-y-2">
          ...
          <textarea 
            ...
            className={`w-full bg-black/60 border p-4 text-white text-sm focus:outline-none transition-colors rounded-2xl font-sans resize-none placeholder:text-neutral-600 ${
              touched.message && errors.message ? 'border-red-500' : 'border-white/15 focus:border-emerald-500'
            }`} 
